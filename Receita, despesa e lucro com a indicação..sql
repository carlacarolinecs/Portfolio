...
WHERE c.indicador > 0 -- Alguem que foi indicado
	 ...
	 and DATEPART(month, c.data_cadastro) = 7 -- um cliente que foi indicado e não indicou ninguem vai ser contado de novo, por isso será necessário utilizar data_cadastro.
GROUP BY p.mes_ano
